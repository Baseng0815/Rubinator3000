...
namespace RubinatorMobile.Droid
{
    public static class ResourceManager
    {
        ...
        {
            LoadedTextures.Add("cubeBlendFrame", new Texture("Textures/BlendFrame.png", activity));
            LoadedTextures.Add("cubeBumpMap", new Texture("Textures/NormalMap1.png", activity));
        ...
        private static void InitFlatData()
        {
            ...
            LoadedTextures.Add("flatBlendFrame", new Texture("Textures/BlendFrameThick.png", activity));
        }
        ...
        public static void InitResourceManager(Activity activity)
        {
            ...
            ResourceManager.activity = activity;
