...
namespace RubinatorMobile.Droid {
    public static class CuboidTransformations {
        ...
        /// </para>
        /// </summary>
        public static void InitCuboidTransformations(Activity activity) {
            ...
            string[] lines;
            using (StreamReader reader = new StreamReader(activity.Assets.Open("CuboidTileMappings.txt"))) {
                lines = reader.ReadToEnd().Split("\n").Where(e => !e.Contains("//")).ToArray();
            }
            int lineIndex = 0;
